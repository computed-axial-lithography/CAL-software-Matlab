...
proj_params.cone_angle = 20;

% set optimization parameters
opt_params.max_iter = 60;
opt_params.threshold = 0.75;
...
stl_filename = 'truncatedoctahedroncells12deg.stl';%loadExStlFilename('octet'); % acceptable inputs 'bear', 'thinker', 'octet', 'octahedron'
